...
enum : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 429,
    ...
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 430,
    ...
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 431,
    SBK_QLOCALE_IDX                                          = 174,
    ...
    SBK_QT_CURSORMOVESTYLE_IDX                               = 433,
    ...
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 427,
    SBK_QCBORKNOWNTAGS_IDX                                   = 31,
    SBK_QCBORSIMPLETYPE_IDX                                  = 34,
    SBK_QCBORTAG_IDX                                         = 41,
    SBK_QTMSGTYPE_IDX                                        = 428,
    SBK_QtCore_IDX_COUNT                                     = 434
};
